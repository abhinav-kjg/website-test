...
import DevApproach from "@/public/services/DataAnalyticsDevApproach.png";

export default function DataAnalyticsDevelopmentApproach() {
    return (
        <main className="px-6 py-7">
            <h1 className="text-3xl md:text-4xl text-center font-bold text-primary-blue mb-12 tracking-wide">
                Digital Marketing Development Approach at KayJay Global
                Solutions
            </h1>
