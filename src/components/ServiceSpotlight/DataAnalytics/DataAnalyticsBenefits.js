...
const BenefitsData = {
    title: "Benefits of Data Analytics and Insights",
    benefits: [
...
export default function DataAnalyticsBenefitsComponent() {
    return (
        <main className="my-2 mb-10">
            <h1 className="text-3xl md:text-4xl text-center font-bold text-primary-blue mb-10 ">
                {BenefitsData.title}
            </h1>
